        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <span className="text-foreground font-bold text-xl">Vendora POS</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-muted-foreground">support@vendorapos.com</span>
              </li>
              <li className="text-muted-foreground">
                <p>Institutional Area, Phase 2, Industrial Area</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="md:flex md:items-center md:justify-between">
            <div className="text-sm text-muted-foreground">
              <p>&copy; {currentYear}  Vendora POS. All rights reserved.</p>
            </div>
