...
public class ShiftReportServiceImpl implements ShiftReportService {
    ...
    public ShiftReport startShift(
        ...
        LocalDateTime startOfDay =
                shiftStart.withHour(0)
                        .withMinute(0)
                        .withSecond(0);


        LocalDateTime endOfDay =
                shiftStart.withHour(23)
                        .withMinute(59)
                        .withSecond(59);


        Optional<ShiftReport> existing =
    ...
    @Override
    public List<ShiftReport> getShiftReportsByCashier(
            Long cashierId
    ) {
    ...
    @Override
    public List<ShiftReport> getShiftReportsByBranch(
            Long branchId
    ) {
    ...
    @Override
    public ShiftReport getCurrentShiftProgress(
            Long cashierId
    ) throws UserException {
        ...
        ShiftReport shift =
                shiftReportRepository
                        ...
                        .orElseThrow(() ->
                                new RuntimeException(
                                        "No active shift found for this cashier"
                                ));
    ...
    @Override
    public ShiftReport getShiftReportByCashierAndDate(
            Long cashierId,
            LocalDateTime date
    ) {
        ...
        return shiftReportRepository
                ...
                .orElseThrow(() ->
                        new RuntimeException(
                                "No shift report found on this date"
                        ));
    }
    ...
    private List<Product> getTopSellingProducts(
            List<Order> orders
    ) {
