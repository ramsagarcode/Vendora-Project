        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <span className="text-foreground font-bold text-xl">Vendora</span>
            </div>
            <p className="mb-4 text-muted-foreground max-w-md">
             Vendora is here to empower retailers with smart point-of-sale solutions that streamline operations, 
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-muted-foreground">support@vendora.com</span>
              </li>
              <li className="text-muted-foreground">
                <p>CDAC Tech Park, Sector 62</p>
