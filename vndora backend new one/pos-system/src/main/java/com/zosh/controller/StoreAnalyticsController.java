...
public class StoreAnalyticsController {
    ...
    public StoreAnalyticsController(StoreAnalyticsService storeAnalyticsService) {
    ...
    public TimeSeriesDataDTO getSalesTrends(
        ...
        return storeAnalyticsService.getSalesTrends(storeAdminId, period);
    }

    // Monthly Sales Chart (Line)
    @GetMapping("/{storeAdminId}/sales/monthly")
    public List<TimeSeriesPointDTO> getMonthlySales(
            @PathVariable Long storeAdminId) {
    ...
    @GetMapping("/{storeAdminId}/sales/daily")
    public List<TimeSeriesPointDTO> getDailySales(
            @PathVariable Long storeAdminId) {
